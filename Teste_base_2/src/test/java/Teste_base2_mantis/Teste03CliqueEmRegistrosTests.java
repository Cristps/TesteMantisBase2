...
@DisplayName("Testes automatizados da Funcionalidade Verificar se clica na pagina de registros")
public class Teste03CliqueEmRegistrosTests {
    public Teste03CliqueEmRegistrosTests() {
    }
    ...
    public void testRegistrarUmNovoUsuarioComDadosValidos() {
        ...
        // Clicar no botão "Registros de Alteração" usando a class: menu-icon fa fa-retweet
