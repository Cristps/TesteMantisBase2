...
@DisplayName("Testes automatizados da Funcionalidade Verificar se clicar no Roadmap")
public class Teste04CliqueEmRoadmapTests {
    public Teste04CliqueEmRoadmapTests() {
    }
    ...
    public void testRegistrarUmNovoUsuarioComDadosValidos() {
        ...
        //Clicar no botão "Roadmap" na class: menu-icon fa fa-road
